...
func main() {
	...
	network.AddElULayer(12)
	//network.AddLeakyRelULayer(12)
	//network.AddRelULayer(12)
	//network.AddRelULayer(10)
	network.AddRelULayer(8)
	//network.AddSigmoidLayer(12)
	//network.AddSigmoidLayer(8)
	network.AddSigmoidLayer(2)
	//network.AddRelULayer(2)
	//network.AddDenseLayer(2)
	//network.AddLeakyRelULayer(2)

	//network.AddLayer(GoNeuralNetwork.CreateLayer(4, 2, GoNeuralNetwork.Sigmoid, GoNeuralNetwork.DerivativeSigmoid))
	//network.Show()
